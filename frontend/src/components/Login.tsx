...
import { registerUser, loginWithUsername, loginWithQR } from "../services/authService";
...
export const Login: React.FC<{ onLogin: () => void }> = ({ onLogin }) => {
    ...
    const handleCreatePasskey = async () => {
        ...
        try {
            // MVP: Generate fake email to satisfy interface
            const fakeEmail = `${username.trim()}@sharecar.local`;
            const result = await registerUser(username.trim(), fakeEmail);
    ...
    const handleAuthenticate = async () => {
        ...
        try {
            const result = await loginWithUsername(username.trim());
    ...
    const handleQRLogin = async () => {
        ...
        try {
            const result = await loginWithQR(qrInput.trim());
